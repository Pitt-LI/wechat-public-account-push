...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      useTemplateId: 'Nh5nIZj-dEImIN6KKf4hZBTuKlqg0Loa7MF6uiVwsL0',
      ...
      festivals: [
        ...
        {
          type: '生日', name: '相识一周年', year: '2022', date: '04-22',
        },
      ],
      // 我们在一起已经有xxxx天了的配置
      customizedDateList: [
  ...
  CALLBACK_TEMPLATE_ID: 'Nh5nIZj-dEImIN6KKf4hZBTuKlqg0Loa7MF6uiVwsL0',
